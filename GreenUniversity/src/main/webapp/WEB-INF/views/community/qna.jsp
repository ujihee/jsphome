						...
						<div class="bottom">
							<table class="notice-table">
								...
								<tbody>
									<tr>
										<td>5</td>
										<td><span class="lock"><img
												src="./images/ico-lock.png" alt="new"></span> 문의드립니다.</td>
										<td>홍길동</td>
										<td>24.04.09</td>
									...
									<tr style="background-color: #efefef">
										<td>3</td>
										<td><span class="lcok"><img
												src="./images/ico-reply.png" alt="new"></span> RE:[답변]취업진로상담</td>
										<td>담당자</td>
										<td>24.04.09</td>
										<td style="color: green;">답변완료</td>
									</tr>
									<tr>
										<td>2</td>
										<td><span class="lcok"><img
												src="./images/ico-lock.png" alt="new"></span> 취업실전전략1 일반선택
											교과목 문의입니다</td>
										<td>학사지원실</td>
										<td>24.04.09</td>
										<td style="color: green;">답변완료</td>
									...
									<tr style="background-color: #efefef">
										<td>1</td>
										<td><span class="lcok"><img
												src="./images/ico-reply.png" alt="new"></span> RE:[답변]취업실전전략1
											일반선택 교과목 문의입니다</td>
										<td>학사지원실</td>
										<td>24.04.09</td>
										<td style="color: green;">답변완료</td>
