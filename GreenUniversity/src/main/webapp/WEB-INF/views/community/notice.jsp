						...
						<div class="bottom">
							<table class="notice-table">
								...
								<tbody>
									<tr>
										<td>3</td>
										<td><span class="new-icon"><img
												src="./images/ico-new01.gif" alt="new"></span> 2025학년도 1학기
											그린장학회 장학생 신청 안내</td>
										<td>학사지원실</td>
										<td>24.04.09</td>
										<td>160</td>
									...
									<tr>
										<td>3</td>
										<td><span class="new-icon"><img
												src="./images/ico-new01.gif" alt="new"></span> 제42회 학위수여식 안내</td>
										<td>학사지원실</td>
										<td>24.04.09</td>
										<td>160</td>
									</tr>
									<tr>
										<td>3</td>
										<td><span class="new-icon"><img
												src="./images/ico-new01.gif" alt="new"></span> 의료, 인공지능 융합인재
											양성사업단 사업설명회</td>
										<td>학사지원실</td>
										<td>24.04.09</td>
										<td>160</td>
